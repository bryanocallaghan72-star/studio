...
export const CLASS_DROPS: ClassDrop[] = [
    {
      ...
      classImageUrl: 'https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=800&q=80',
      spotsAvailable: 2,
      startTime: new Date(Date.now() + 1 * 60 * 60 * 1000).toISOString(),
    ...
    },
    {
      ...
      classImageUrl: 'https://images.unsplash.com/photo-1505118380757-91f5f5632de0?w=800&q=80',
      spotsAvailable: 3,
      startTime: new Date(Date.now() + 2 * 60 * 60 * 1000).toISOString(),
    ...
    },
    {
      ...
      classImageUrl: 'https://images.unsplash.com/photo-1476480862126-209bfaa8edc8?w=800&q=80',
      spotsAvailable: 3,
      startTime: new Date(Date.now() + 1.5 * 60 * 60 * 1000).toISOString(),
    ...
    },
    {
      ...
      classImageUrl: 'https://images.unsplash.com/photo-1518611012118-696072aa579a?w=800&q=80',
      spotsAvailable: 1,
