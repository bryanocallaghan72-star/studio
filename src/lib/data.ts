...
export const appData = {
  ...
  map: {
    pins: [
      { id: 1, name: "Bondi Icebergs", slug: "bondi-icebergs", type: "Vibes", description: "Iconic ocean views and fine dining.", x: "30%", y: "80%", openingHours: "6am - 6:30pm", vibeTags: ["Iconic", "Views", "Swim"], currentVibe: "Buzzing" },
      { id: 2, name: "Hotel Ravesis", slug: "hotel-ravesis", type: "Nightlife", description: "Stylish beachfront bar and restaurant.", x: "55%", y: "30%", openingHours: "12pm - 12am", vibeTags: ["Stylish", "Rooftop", "Cocktails"], currentVibe: "Packed" },
      { id: 3, name: "The Depot", slug: "the-depot", type: "Brunch", description: "Popular spot for brunch and coffee.", x: "65%", y: "65%", openingHours: "7am - 3pm", vibeTags: ["Casual", "Local Fav", "Coffee"], currentVibe: "Chill" },
      { id: 4, name: "Bondi Beach", slug: "bondi-beach", type: "Vibes", description: "World-famous beach with golden sands and surf.", x: "25%", y: "15%", openingHours: "24/7", vibeTags: ["Beach", "Surf", "Sun"], currentVibe: "Buzzing" },
      { id: 5, name: "Raw Bar", slug: "raw-bar", type: "Sushi", description: "Authentic Japanese sushi and sashimi.", x: "40%", y: "50%", openingHours: "12pm - 10pm", vibeTags: ["Authentic", "Sushi", "Fresh"], currentVibe: "Buzzing" },
      { id: 6, name: "Speedo's Cafe", slug: "speedos-cafe", type: "Brunch", description: "Insta-famous colorful brunch dishes.", x: "80%", y: "25%", openingHours: "7am - 4pm", vibeTags: ["Instagrammable", "Healthy", "Brunch"], currentVibe: "Packed" },
      { id: 7, name: "Totti's", slug: "tottis", type: "Restaurants", description: "Vibrant Italian restaurant with a leafy courtyard.", x: "85%", y: "75%", openingHours: "12pm - 11pm", vibeTags: ["Italian", "Courtyard", "Group Friendly"], currentVibe: "Packed" },
      { id: 8, name: "Bondi Trattoria", slug: "bondi-trattoria", type: "Restaurants", description: "Classic Italian dishes with a sea view.", x: "20%", y: "55%", openingHours: "5pm - 10pm", vibeTags: ["Classic", "Italian", "Sea View"], currentVibe: "Chill" },
      { id: 9, name: "The Corner House", slug: "the-corner-house", type: "Cocktails", description: "Cozy bar with a great cocktail list.", x: "75%", y: "45%", openingHours: "4pm - 12am", vibeTags: ["Cozy", "Cocktails", "Local"], currentVibe: "Buzzing" },
      { id: 10, name: "Harry's Bondi", slug: "harrys-bondi", type: "Brunch", description: "Classic brunch fare with a modern twist.", x: "15%", y: "40%", openingHours: "7am - 3pm", vibeTags: ["Brunch", "Modern", "Coffee"], currentVibe: "Buzzing" },
      { id: 11, name: "LULU", slug: "lulu-pan-asian", type: "Restaurants", description: "Modern Pan-Asian cuisine in a chic setting.", x: "50%", y: "60%", openingHours: "5pm - 11pm", vibeTags: ["Pan-Asian", "Chic", "Dinner"], currentVibe: "Buzzing" },
      { id: 12, name: "RND Izakaya", slug: "rnd-izakaya", type: "Sushi", description: "Japanese pub food and creative cocktails.", x: "10%", y: "70%", openingHours: "5pm - 12am", vibeTags: ["Izakaya", "Japanese", "Fun"], currentVibe: "Packed" },
      { id: 13, name: "Luca and Luca", slug: "luca-and-luca-gelato", type: "Brunch", description: "Artisanal gelato with unique flavors.", x: "70%", y: "20%", openingHours: "11am - 10pm", vibeTags: ["Gelato", "Dessert", "Sweet"], currentVibe: "Chill" },
      { id: 14, name: "Volume One", slug: "volume-one", type: "Cocktails", description: "Hidden gem for craft cocktails.", x: "55%", y: "85%", openingHours: "6pm - 1am", vibeTags: ["Hidden", "Craft", "Intimate"], currentVibe: "Chill" },
      { id: 15, "name": "Bills", "slug": "bills", "type": "Brunch", "description": "Famous for ricotta hotcakes and scrambled eggs.", "x": "45%", "y": "70%", openingHours: "7:30am - 3pm", vibeTags: ["Iconic", "Brunch", "Hotcakes"], currentVibe: "Packed" },
      { id: 16, "name": "Sean's", "slug": "seans", "type": "Restaurants", "description": "Farm-to-table dining with ocean views.", "x": "90%", "y": "10%", openingHours: "6pm - 10pm", vibeTags: ["Farm-to-Table", "Fine Dining", "Views"], currentVibe: "Buzzing" },
      ...
      { id: 18, "name": "The Bucket List", "slug": "the-bucket-list", "type": "Nightlife", description: "Casual beachside bar with a lively atmosphere.", "x": "35%", "y": "25%", openingHours: "12pm - 12am", vibeTags: ["Beachy", "Casual", "Lively"], currentVibe: "Packed" },
      { id: 19, "name": "Porch and Parlour", "slug": "porch-and-parlour", "type": "Brunch", description: "Bohemian-style cafe with healthy options.", "x": "95%", "y": "50%", openingHours: "6:30am - 3pm", vibeTags: ["Bohemian", "Healthy", "Coffee"], currentVibe: "Buzzing" },
      { id: 20, "name": "Anatomy", "slug": "anatomy", "type": "Health & Fitness", description: "Boutique fitness studio offering various classes.", "x": "5%", "y": "50%", openingHours: "6am - 8pm", vibeTags: ["Fitness", "Classes", "Modern"], currentVibe: "Chill" },
      { id: 21, "name": "Acai Brothers", "slug": "acai-brothers", "type": "Health & Fitness", description: "Superfood bar specializing in acai bowls.", "x": "90%", "y": "60%", openingHours: "7am - 5pm", vibeTags: ["Acai", "Healthy", "Quick"], currentVibe: "Buzzing" },
      { id: 22, name: "The Rum Diary Bar", slug: "the-rum-diary-bar", type: "Cocktails", description: "Caribbean-themed bar with a wide rum selection.", x: "5%", y: "80%", openingHours: "5pm - 12am", vibeTags: ["Rum", "Themed", "Cozy"], currentVibe: "Chill" },
      { id: 23, name: "Lulu", slug: "lulu", type: "Restaurants", description: "Modern Pan-Asian cuisine in a chic setting.", x: "50%", y: "60%", openingHours: "5pm - 11pm", vibeTags: ["Pan-Asian", "Chic", "Dinner"], currentVibe: "Packed" },
