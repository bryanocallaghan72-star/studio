/**
 * @fileOverview Google Places Compliance Script
 * Removes openingHours fields from the Firestore 'venues' collection
 * to ensure compliance with Google Maps Platform Terms of Service regarding 
 * the caching of volatile data.
 */
...
async function main() {
  console.log('🧹 Starting cleanup of Google Opening Hours from Firestore...');
  ...
  for (const doc of snapshot.docs) {
    ...
    try {
      // Remove openingHours fields using FieldValue.delete()
